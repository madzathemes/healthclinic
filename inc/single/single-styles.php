...
<?php $ls = get_post_meta(get_the_ID(), "magazin_post_sidebar", true); $fl = "pull-left"; $fs = "pull-right"; $o = get_option("healthclinic_theme_options"); if(!empty($ls)){ $l = $ls; } else { if(!empty($o['post_sidebar'])){ $l = $o['post_sidebar']; } else { 	$l = "left"; } } if ($l == "left") { $fl = "pull-left"; $fs = "pull-right"; } ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-col-1 col-md-1 sidebar theiaStickySidebar">
        <?php healthclinic_single_cat(); ?>
        <?php healthclinic_single_cat_posts(); ?>
      </div>
      <div class="single-content col-col-2 col-md-7 <?php echo sanitize_html_class($fl); ?>">

        <?php healthclinic_single_title(); ?>
        <?php healthclinic_single_social(); ?>
        <?php healthclinic_single_media(); ?>
        <?php healthclinic_single_top(); ?>
        <div class="entry-content" itemprop="articleBody"><?php the_content(); ?></div>
        <?php healthclinic_single_bottom(); ?>
      </div>
      <div class="col-col-3 col-md-4 <?php echo sanitize_html_class($fs); ?> sidebar theiaStickySidebar" itemscope="itemscope" itemtype="http://schema.org/WPSideBar">
        <?php healthclinic_single_sidebar(); ?>
      </div>
    </div>
  </div>
</div>
...
<?php $ls = get_post_meta(get_the_ID(), "magazin_post_sidebar", true); $fl = "pull-left"; $fs = "pull-right"; $o = get_option("healthclinic_theme_options"); if(!empty($ls)){ $l = $ls; } else { if(!empty($o['post_sidebar'])){ $l = $o['post_sidebar']; } else { 	$l = "left"; } } if ($l == "left") { $fl = "pull-right"; $fs = "pull-left"; } ?>
<div class="post-content-wrap mt-content-container" itemprop="mainEntityOfPage">
  <div class="container">
    <div class="row">
      <div class="col-col-1 col-md-1 sidebar theiaStickySidebar">
...
<div class="post-media-wrap">
  <div class="container">
    <div class="single-media-top"><?php healthclinic_single_media(); ?></div>
  </div>
</div>
<div class="post-content-wrap mt-content-container" itemprop="mainEntityOfPage">
  <div class="container">
