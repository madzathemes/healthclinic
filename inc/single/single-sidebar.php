<?php function healthclinic_single_sidebar() {?>
  ...
  <?php } else { ?>
    ...
    <?php if ( shortcode_exists( 'posts' ) ) { echo do_shortcode('[posts type=normal title="'. esc_html__( 'Featured Post','healthclinic' ) .'" title_type="center" offset="0" item_nr=1]'); } ?>
    ...
    <h2 class="heading"><span><?php esc_html_e('Trending Posts', 'healthclinic'); ?></span></h2>
