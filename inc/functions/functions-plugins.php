...
add_action( 'tgmpa_register', 'healthclinic_register_required_plugins' );
/**
 ...
 */
function healthclinic_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'			=> esc_html__( "Envato WordPress Toolkit","healthclinic" ), // The plugin name
        ...
        array(
        			'name'     				=> esc_html__( "One Click Demo Import","healthclinic" ), // The plugin name
     ...
     */
    $config = array(
      'id'           => 'healthclinic',                // Unique ID for hashing notices for multiple instances of TGMPA.
